package com.pavesid.subsmanager.objects
...
class DatePicker(private val context: Context, private val view: TextView, private val initTime: Long = 0L) {

    private var dateAndTime: Calendar? = null

    val time: Long
        get() = dateAndTime?.timeInMillis ?: 0L
